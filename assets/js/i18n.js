...
(function() {
  ...
  var EN = {
    ...
    'ai.welcome': "Hi, I'm KevinTen's AI guide. I answer common site questions instantly and use the live model for deeper questions.",
    ...
    'ai.clear': 'Clear',
    'ai.open': 'Open AI guide',
    'ai.close': 'Close AI guide',
    'ai.send': 'Send question',
    'ai.ready': 'Ready',
    'ai.online': 'AI answer ready',
    'ai.thinking': 'Thinking',
    'ai.offline': 'The live guide is temporarily unavailable. Try a suggested site question or use the links below.',
    'ai.rateLimit': 'Too many questions at once. Please wait a moment and try again.',
    'ai.error': 'The live model is temporarily unavailable. Try one of the suggested site questions.',
    'ai.you': 'You',
    'ai.source.model': 'AI generated',
    'ai.source.knowledge': 'Site knowledge',
    'ai.link.projects': 'View projects',
    'ai.link.tech': 'View tech stack',
    'ai.link.experience': 'View experience',
    'ai.link.writing': 'Read articles',
    'ai.link.contact': 'Contact KevinTen',
  ...
  var originalTexts = {
    ...
    'ai.welcome': '你好，我是 KevinTen 的 AI 导览。常见站内问题我会即时回答，更深入的问题会交给在线模型。',
    ...
    'ai.online': 'AI 回答已生成',
    'ai.thinking': '思考中',
    'ai.offline': '在线导览暂时不可用，可以先试试上面的站内问题或使用下方链接。',
    'ai.rateLimit': '提问有点频繁，请稍等片刻再试。',
    'ai.error': '在线模型暂时不可用，可以先试试上面的站内问题。',
    'ai.you': '你',
    'ai.source.model': 'AI 生成',
    'ai.source.knowledge': '站内知识',
    'ai.link.projects': '查看项目',
    'ai.link.tech': '查看技术栈',
    'ai.link.experience': '查看经历',
    'ai.link.writing': '阅读文章',
    'ai.link.contact': '联系 KevinTen',
